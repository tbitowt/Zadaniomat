...
export const coloring: GeneratorDef = {
  ...
  fields: [
    ...
    },
    {
      ...
      help: 'Szersza siatka to wierniejszy obrazek, ale też więcej działań i drobniejszy druk. Rysunek ze szczegółami potrzebuje co najmniej 18 kratek.',
    },
    {
      kind: 'number',
      key: 'maxColors',
    ...
    },
    {
      ...
      maxHeight: 30,
      showIf: (cfg) => source(cfg) === 'image',
      help: 'Tło jest odcinane, rysunek przycinany do kadru i dzielony na kratki, a kolory sprowadzane do wybranej liczby kredek. Gotowa kolorowanka — same czarne kreski na białym — wychodzi jako obrysowany kontur. Napisy i znaki wodne na obrazku zamieniają się w szum.',
    },
