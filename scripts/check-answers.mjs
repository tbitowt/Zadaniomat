...
const cases = [
  ...
  { card: 'Dodawanie w pamięci', tweak: (p) => setSelect(p, 'Szukana liczba', 'term0') },
  { card: 'Odejmowanie w pamięci', tweak: (p) => setSelect(p, 'Szukana liczba', 'term0') },
  { card: 'Dzielenie w pamięci', tweak: (p) => setSelect(p, 'Szukana liczba', 'term1') },
